...
class PosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $resultado = DB::transaction(function () use ($request, $userId, $empresa, $turnoActivo) {
                ...
                $formaPago = in_array($request->forma_pago, ['contado', 'efectivo']) ? 'contado' : $request->forma_pago;
            ...
            return response()->json([
                ...
                'ticket_url'     => route('pos.ticket', $resultado['id']),
            ]);
        } catch (\Throwable $e) {
            \Illuminate\Support\Facades\Log::error('Error procesando venta POS: ' . $e->getMessage(), [
