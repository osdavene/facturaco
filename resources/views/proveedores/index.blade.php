...
<div class="card overflow-hidden">
    ...
    <form id="bulk-form" method="POST" action="{{ route('proveedores.bulk-delete') }}">
        @csrf @method('DELETE')
    </form>
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="table-row">
                    <td class="px-4 py-4">
                        <input type="checkbox" class="bulk-item w-4 h-4 rounded border-[#2d3f5c]
                               bg-[#1a2235] accent-amber-500 cursor-pointer" value="{{ $proveedor->id }}">
                    </td>
                    <td class="px-5 py-4">
                ...
                <x-empty-state
                    ...
                    subtitle="Registra tus proveedores para gestionar órdenes de compra y pagos."
