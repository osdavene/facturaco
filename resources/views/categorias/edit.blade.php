...
@section('page-title', 'Configuración · Editar Categoría')
...
<div class="max-w-xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="font-display font-bold text-2xl">Editar Categoría</h1>
            <p class="text-slate-500 text-sm">{{ $categoria->nombre }}</p>
        </div>
    </div>
        ...
        <div class="card p-6 space-y-5">
            ...
            <div class="p-4 bg-[#1a2235] rounded-xl border border-[#1e2d47]">
                <label class="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                        <div class="text-sm font-semibold text-slate-300">Categoría activa</div>
                        <div class="text-xs text-slate-500 mt-0.5">
                            Solo las categorías activas aparecen al crear productos
                        </div>
                    </div>
                </label>
            </div>
