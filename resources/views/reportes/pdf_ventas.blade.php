...
<style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .periodo { font-size:11px; font-weight:bold; }

    .kpis { display:table; width:100%; margin-bottom:16px; }
    .kpi  { display:table-cell; width:25%; text-align:center; padding:10px;
    ...
    tfoot td { padding:7px 8px; font-weight:bold; background:#1a1a1a; color:#fff; font-size:10px; }
...
<div class="page">
    ...
    <div class="kpis">
        <div class="kpi" style="margin-right:8px;">
            <div class="kpi-val">{{ $totales['count'] }}</div>
            <div class="kpi-lab">Facturas</div>
        </div>
        <div class="kpi" style="margin-right:8px;">
            <div class="kpi-val">${{ number_format($totales['subtotal'],0,',','.') }}</div>
            <div class="kpi-lab">Subtotal</div>
        </div>
        <div class="kpi" style="margin-right:8px;">
            <div class="kpi-val">${{ number_format($totales['iva'],0,',','.') }}</div>
            <div class="kpi-lab">IVA</div>
        </div>
        <div class="kpi">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">${{ number_format($f->iva,0,',','.') }}</td>
                <td class="text-right" style="font-weight:bold;">${{ number_format($f->total,0,',','.') }}</td>
        ...
        <tfoot>
            <tr>
                <td colspan="3">TOTALES ({{ $totales['count'] }} facturas)</td>
